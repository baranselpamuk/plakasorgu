...
$ne_duzenlenecek = mysqli_query($connn, "SELECT * FROM arac_kayitlari WHERE w_id=$duzenlecenek ");
              ...
              <div class="card-body">
                <form action="gorev_edit_db.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="aracsahibi" name="aracsahibi" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_sahip']; ?>" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Plaka No</label>
                    <input type="text" id="aracplaka" name="aracplaka" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_plaka']; ?>" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label class="control-label">İletişim No</label>
                    <input type="text" id="iletisimno" name="iletisimno" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_iletisim']; ?>" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Araç Marka</label>
                    <input type="text" id="aracmarka" name="aracmarka" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_marka']; ?>" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Araç Model</label>
                    <input type="text" id="aracmodel" name="aracmodel" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_model']; ?>" autocomplete="off">
                  </div>

                   <div class="form-group">
                    <label class="control-label">Model Yılı</label>
                    <input type="text" id="modelyili" name="modelyili" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_model_yili']; ?>" autocomplete="off">
                  </div>

                   <div class="form-group">
                    <label class="control-label">Araç Şasi</label>
                    <input type="text" id="aracsasi" name="aracsasi" class="form-control" value="<?php echo $duzenlenecegi_ayr['w_aracsasi']; ?>" autocomplete="off">
                  </div>
...
<div class="form-group">
         ...
         <!--checked-->             
                      <label>
                        <?php 
if ($duzenlenecegi_ayr['w_durumu']=="Bulundu") {
  echo '<input type="radio" name="AracDurumu" value="Bulundu" checked><font color="#3a68bf"><b>Bulundu</b></font>';
}else{
  echo '<input type="radio" name="AracDurumu" value="Bulundu" ><font color="#3a68bf"><b>Bulundu</b></font>';
}
                         ?>
                      </label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <label>
                        <?php 
if ($duzenlenecegi_ayr['w_durumu']=="Çalıntı") {
  echo '<input type="radio" name="AracDurumu" value="Çalıntı" checked><font color="red"><b>Çalıntı</b></font>';
}else{
  echo '<input type="radio" name="AracDurumu" value="Çalıntı"><font color="red"><b>Çalıntı</b></font>';
}
                         ?>
                      </label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <label>
                        <?php 
if ($duzenlenecegi_ayr['w_durumu']=="Diğer") {
  echo '<input type="radio" name="AracDurumu" value="Diğer" checked><font color="#ff9800"><b>Diğer</b></font>';
}else{
  echo '<input type="radio" name="AracDurumu" value="Diğer"><font color="#ff9800"><b>Diğer</b></font>';
}
                         ?>
                      </label>
<br><br>
